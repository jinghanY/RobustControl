...
class L1System:
    def __init__(self, Cf_lower=23000, Cf_upper=43000, Cr_lower=23000, Cr_upper=43000, V=25.38):

        # Ground truth of frictions
        Cf = 31234
        Cr = 31234
        R = 20
    ...
    def l1_system(self, t, x_all):
        ...
        self.U_S = torch.cat([self.U_S, u_all])
