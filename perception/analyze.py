...
if __name__ == "__main__":
    latex_table_certified_accuracy(
        "analysis/latex/vary_noise_carla", 0.5, 3.0, 0.5, [
            #Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.12/test/sigma_0.12"), "$\sigma = 0.12$"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.25/test/sigma_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.50/test/sigma_0.50"), "$\sigma = 0.50$"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_1.00/test/sigma_1.00"), "$\sigma = 1.00$"),
        ])
    markdown_table_certified_accuracy(
        "analysis/markdown/vary_noise_carla", 0.5, 3.0, 0.5, [
            #Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.12/test/sigma_0.12"), "&sigma; = 0.12"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.25/test/sigma_0.25"), "&sigma; = 0.25"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.50/test/sigma_0.50"), "&sigma; = 0.50"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_1.00/test/sigma_1.00"), "&sigma; = 1.00"),
    ...
    plot_certified_accuracy(
        "analysis/plots/vary_noise_carla", "CarlaFrames, vary $\sigma$", 4, [
            #Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.12/test/sigma_0.12"), "$\sigma = 0.12$"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.25/test/sigma_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.50/test/sigma_0.50"), "$\sigma = 0.50$"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_1.00/test/sigma_1.00"), "$\sigma = 1.00$"),
    ...
    plot_certified_accuracy(
        "analysis/plots/vary_train_noise_carla_050", "CarlaFrames, vary train noise, $\sigma=0.5$", 1.5, [
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.25/test/sigma_0.50"), "train $\sigma = 0.25$"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.50/test/sigma_0.50"), "train $\sigma = 0.50$"),
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_1.00/test/sigma_0.50"), "train $\sigma = 1.00$"),
        ])
    plot_certified_accuracy(
        "analysis/plots/high_prob", "Approximate vs. High-Probability", 2.0, [
            Line(ApproximateAccuracy("data/certify/carla/resnet50/noise_0.50/test/sigma_0.50"), "Approximate"),
            Line(HighProbAccuracy("data/certify/carla/resnet50/noise_0.50/test/sigma_0.50", 0.001, 0.001), "High-Prob"),
        ])
